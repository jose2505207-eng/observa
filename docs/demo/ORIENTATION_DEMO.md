...
3. Hear the opening: *"Orientation on. Acquiring GPS toward home."*
4. Once a fix is acquired, hear guidance every ~4 s, e.g.
   *"Slight right, 1 o'clock. 40 meters."* / *"Continue straight, 25 meters."* / *"Turn around safely."*
...
7. Point the camera at a person while orientation runs → the **hazard interrupts** orientation
   (HAZARD > NAVIGATION), proving safety priority.

## Honest states to expect
- No fix yet / indoors: *"GPS unavailable. Cannot guide..."* or *"GPS accuracy low. Use caution."*
- Compass uncalibrated: *"Compass accuracy low. Calibrate phone."* (figure-8 motion).
